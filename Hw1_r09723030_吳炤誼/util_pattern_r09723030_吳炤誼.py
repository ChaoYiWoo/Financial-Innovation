...
def pattern(df, signal, timeScale, path = None):         
    ...
    # 繪出前幾根K棒的趨勢線
    global end_idx
    if signal == ('Threeblackcrows' or 'EveningStar' or 'MorningStar'):
        end_idx = 7
    elif signal == ('ShootingStar' or 'InvertHammer'):
        end_idx = 9
    elif signal == ('BullishReversal' or 'BearishHarami' or 'BearishEngulfing' or 'BullishHarami' or 'BullishEngulfing'):
        end_idx = 8 
