...
if __name__ == "__main__":
    filename_raw = 'C:/Users/ben82/OneDrive/桌面/課程/金融創新/Hw1/eurusd_2010.csv'
    filename_pro = 'C:/Users/ben82/OneDrive/桌面/課程/金融創新/Hw1/eurusd_2010_1T.csv'
    filename_rule = 'C:/Users/ben82/OneDrive/桌面/課程/金融創新/Hw1/eurusd_2010_1T_rulebase.csv'
    pattern_path = 'C:/Users/ben82/OneDrive/桌面/課程/金融創新/Hw1/pattern'
    timeScale = '1min'
    '''signal_ls = ['Threeblackcrows','BullishReversal','EveningStar', 'MorningStar', 'ShootingStar', 
    ...
    # 繪出在各個交易訊號中2個pattern
    signal_ls = ['Threeblackcrows','BullishReversal']
    for signal in signal_ls:
        path = 'C:/Users/ben82/OneDrive/桌面/課程/金融創新/Hw1/pattern/' + str(signal) 
        os.mkdir(path)
        M.graph(signal)
